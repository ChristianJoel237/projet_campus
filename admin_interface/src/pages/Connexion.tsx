      ...
      >
        ...
        >
          ...
          <div className="relative">
            ...
            <h1 className="text-2xl font-bold text-white">{t.auth?.titreConnexion || "MicroFinance Admin"}</h1>
        ...
        <div className="p-8">
          <div className="space-y-5">
            ...
            >
              <Shield size={14} style={{ color: "#16a34a" }} aria-hidden="true" />
            ...
            <form onSubmit={handleSoumission} className="space-y-4" noValidate autoComplete="off">
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow: chargement ? "none" : "0 4px 14px rgba(22,163,74,0.4)",
