...
const Epargnes = () => {
    ...
    // 1. FILTRAGE DYNAMIQUE (Pour le tableau et le meilleur épargnant)
    ...
    // 2. INDICATEURS GLOBAUX (Restent stables pour le tableau de bord)
    ...
    // 3. MEILLEUR ÉPARGNANT DYNAMIQUE (Calculé parmi les éléments filtrés/visibles)
    const epargnantActif = epargnesFiltrees.reduce(
        (max: Epargne | null, e: Epargne) => {
            if (!max) return e;
            return e.solde > max.solde ? e : max;
