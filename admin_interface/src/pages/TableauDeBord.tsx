    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        <div className="carte">
          ...
          <div className="space-y-1">
            {credits.slice(0, 5).map((c: Credit) => (
              <div
                key={c.id}
                className="flex items-center justify-between py-3 px-3 rounded-xl
                hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
...
// Le terme de recherche vient maintenant du parent (BarreNavigation -> Parent -> TableauDeBord)
...
const TableauDeBord = ({ termeRecherche = "" }: TableauDeBordProps) => {
    ...
    return (
        <div className="space-y-6">
            ...
            {/* BARRE DE RECHERCHE LOCAL SUPPRIMÉE ICI (Gérée globalement par BarreNavigation) */}
