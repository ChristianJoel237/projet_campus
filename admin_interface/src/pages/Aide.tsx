...
const Aide = () => {
  ...
  const faqItems: FaqItem[] = [
    ...
    },
    {
      ...
      reponse:
        t.aide?.faq3R ||
        "Depuis la page Agents, cliquez sur 'Suspendre' ou depuis son profil.",
    },
    {
  ...
  const notifItems: {
  ...
  }[] = [
    {
      ...
      description:
        t.parametres?.notifNouveauCreditDesc ||
        'Alertes pour chaque nouvelle demande',
    },
    {
      cle: 'remboursement',
      emoji: '✅',
      ...
      description:
        t.parametres?.notifRemboursementDesc || 'Confirmer les paiements reçus',
    },
    {
      cle: 'retard',
      emoji: '⚠️',
      ...
      description:
        t.parametres?.notifRetardDesc || 'Alertes pour les retards de paiement',
    },
    {
      ...
      description:
        t.parametres?.notifNouvelUtilisateurDesc ||
        'Notification à chaque inscription',
    },
    {
      cle: 'rapportHebdo',
      emoji: '📊',
      ...
      description:
        t.parametres?.notifRapportHebdoDesc ||
        ...
        <div>
          ...
          <div className="carte">
            ...
            <Etape
              ...
              description={
                t.aide?.uEtape2Desc ||
                'Filtrez la liste par statut : Actif, Inactif ou Suspendu.'
              }
            />
            <Etape
              numero="3"
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <div className="carte">
            <Etape
              ...
              description={
                t.agentsTerrain?.etape1Desc ||
                "Dans le menu latéral, cliquez sur 'Agents de terrain'"
              }
            />
            <Etape
              numero="2"
              titre={
                t.agentsTerrain?.etape2Titre || "Cliquer sur 'Nouvel agent'"
              }
              description={
                t.agentsTerrain?.etape2Desc ||
            ...
            <Etape
              ...
              description={
                t.agentsTerrain?.etape3Desc ||
                'Nom, prénom, téléphone, ville, email et mot de passe'
              }
            />
            <Etape
              numero="4"
        ...
        <div>
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            >
              <Plus size={12} />{' '}
              {t.agentsTerrain?.nouvelAgent || 'Nouvel agent'}
            </button>
          </div>

          <SimulationEcran
            titre={t.agentsTerrain?.listeTitre || 'Agents de terrain'}
          >
            {vueAgents === 'tableau' ? (
                ...
                {agentsDemo.map((agent) => (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between text-xs text-gray-500">
                      ...
                      <span>
                        📁 {agent.dossiers}{' '}
                        {t.agentsTerrain?.dossiers || 'dossiers'}
                      </span>
                    </div>
                  </div>
                ))}
        ...
        <div>
          ...
          <SimulationEcran
            titre={t.agentsTerrain?.titre || 'Nouvel agent de terrain'}
          >
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            {t.credits?.description ||
              'Gérez les microcrédits accordés aux commerçants.'}
          </p>
        </div>
        ...
        <div>
          ...
          <div className="carte">
            <Etape
              numero="1"
              titre={
                t.aide?.cEtape1Titre || 'Identifier les demandes en attente'
              }
              description={
                t.aide?.cEtape1Desc ||
            ...
            <Etape
              ...
              description={
                t.aide?.cEtape4Desc ||
                'Confirmez votre décision. Les fonds sont débloqués sous 24h.'
              }
            />
          </div>
        </div>
    ...
    epargnes: (
      <div className="space-y-6">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            {t.epargnes?.description ||
              "Suivez les comptes d'épargne des commerçants."}
          </p>
        </div>
        ...
        <div>
          ...
          <div className="carte">
            <Etape
              ...
              description={
                t.aide?.eEtape1Desc ||
                'Le commerçant effectue un dépôt chaque jour.'
              }
            />
            <Etape
              numero="2"
              ...
              description={
                t.aide?.eEtape2Desc ||
                'Le commerçant effectue un dépôt chaque semaine.'
              }
            />
            <Etape
              numero="3"
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            ...
            <div
              key={i}
              className="p-3 rounded-xl border border-gray-100 dark:border-gray-800 text-center"
            >
      ...
      <div className="space-y-6">
              ...
              {[
                {
                  id: 'notifications',
                  icone: '🔔',
                  label: t.parametres?.notifications || 'Notifications',
                },
                {
                  id: 'application',
                  icone: '⚙️',
                  label: t.parametres?.application || 'Application',
                },
              ].map((onglet) => (
                <button
                  key={onglet.id}
              ...
              {ongletParam === 'notifications' && (
                <div className="space-y-2">
                  ...
                  <button
                    onClick={() =>
                      afficherMessageDemo(
                        t.erreurs?.notificationsSauvegardees ||
                  ...
                  >
                    <Save size={12} />{' '}
                    {t.parametres?.sauvegarderNotifications || 'Sauvegarder'}
                  </button>
                </div>
              )}
              ...
              {ongletParam === 'application' && (
                <div className="space-y-3">
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <ToggleIOS
                        ...
                        iconeInactif="☀️"
                        ariaLabel={
                          themeDemoSombre ? 'Mode Clair' : 'Mode Sombre'
                        }
                      />
                    </div>
                  </div>
                  ...
                  <button
                    onClick={() =>
                      afficherMessageDemo(
                        t.erreurs?.parametresSauvegardes ||
                  ...
                  >
                    <Save size={12} />{' '}
                    {t.parametres?.sauvegarderParametres || 'Sauvegarder'}
                  </button>
                </div>
              )}
            </div>
        ...
        <div className="flex items-center gap-3 p-3 rounded-xl border border-gray-100 dark:border-gray-800">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300">
            {t.parametres?.seDeconnecter || 'Se déconnecter'}
          </p>
        </div>

        <Important
          texte={
            t.aide?.importantParametres ||
            'Utilisez un mot de passe fort et unique pour sécuriser votre compte administrateur.'
          }
        />
      </div>
    ),
