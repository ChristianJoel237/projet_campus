...
// Accepte n'importe quelle chaîne pour le statut
...
const Badge = ({ statut }: BadgeProps) => {
  ...
  const configs: Record<string, BadgeConfig> = {
    ...
    suspendu:         { label: t.utilisateurs?.suspendu || "Suspendu",    classe: "badge-danger" },
    // Crédits
...
=======
// src/component/ui/Badge.tsx
import { useLangue } from "../../context/LangueContext";

// On restreint légèrement le type pour documenter mais on garde la flexibilité string
type StatutBadge = string;
